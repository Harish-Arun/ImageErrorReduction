...
errorarray= []
for i in range(1,10):
    img=cv2.imread("Samples/25_perc/error{num}.png".format(num=i),0)
...
R3=res*255
cv2.imwrite("Samples/25_perc/R3.png",R3)
...
R5=res*255
cv2.imwrite("Samples/25_perc/R5.png",R5)
...
R7=res*255
cv2.imwrite("Samples/25_perc/R7.png",R7)
...
R9=res*255
cv2.imwrite("Samples/25_perc/R9.png",R9)